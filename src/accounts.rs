...
impl AccountsDB {
    ...
    pub fn make_checkpointed_copy(&mut self) -> AccountsDB {
        self.checkpoint();
...
impl Accounts {
    ...
    pub fn make_checkpointed_copy(&self) -> Accounts {
        let db = self.accounts_db.write().unwrap().make_checkpointed_copy();
